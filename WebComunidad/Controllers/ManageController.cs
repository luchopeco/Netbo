...
namespace WebComunidad.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult ChangePassword()
        {
            ...
            if (User.Identity.GetUserId() != User.Identity.Name)
            {
                return View();
            }
            TempData["MsjError"]  = "No tiene permisos para cambiar su contraseña desde aqui. Cabmie su contraseña en el dominio de Windows";
        ...
        public async Task<ActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                ViewBag.MsjExito = "Contraseña Modificada Con Exito";
                return View();
            }
            AddErrors(result);
            return View(model);
