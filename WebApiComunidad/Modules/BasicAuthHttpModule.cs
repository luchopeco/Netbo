...
namespace SCCM.Modules
{
    ...
    {
        private static string UsuarioAutentication => System.Configuration.ConfigurationManager.AppSettings["UusarioAutenticationCORS"];

        private static string PasswordAutentication => System.Configuration.ConfigurationManager.AppSettings["PasswordAutenticationCORS"];
        ...
        private static bool AuthenticateUser(string credentials)
        {
            ...
            if (!(username == UsuarioAutentication && password == PasswordAutentication))
            {
                return false;
            }
